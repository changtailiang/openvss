// ijgs	 IMPORTANT: READ BEFORE DOWNLOADING, COPYING, INSTALLING OR USING. 
// sxph	
// jhrk	 By downloading, copying, installing or using the software you agree to this license.
// zzql	 If you do not agree to this license, do not download, install,
// yysp	 copy or use the software.
// zorg	
// mxss	                          License Agreement
// bymy	         For OpenVSS - Open Source Video Surveillance System
// agfp	
// tgxl	Copyright (C) 2007-2010, Prince of Songkla University, All rights reserved.
// ivbd	
// wfnt	Third party copyrights are property of their respective owners.
// iftg	
// gtct	Redistribution and use in source and binary forms, with or without modification,
// sagu	are permitted provided that the following conditions are met:
// ewfl	
// utjt	  * Redistribution's of source code must retain the above copyright notice,
// uars	    this list of conditions and the following disclaimer.
// ahge	
// nnjg	  * Redistribution's in binary form must reproduce the above copyright notice,
// jzjw	    this list of conditions and the following disclaimer in the documentation
// ffrh	    and/or other materials provided with the distribution.
// elxt	
// zdgl	  * Neither the name of the copyright holders nor the names of its contributors 
// pqjd	    may not be used to endorse or promote products derived from this software 
// wuyh	    without specific prior written permission.
// oagz	
// mxgf	This software is provided by the copyright holders and contributors "as is" and
// ralf	any express or implied warranties, including, but not limited to, the implied
// njfo	warranties of merchantability and fitness for a particular purpose are disclaimed.
// bcpj	In no event shall the Prince of Songkla University or contributors be liable 
// dytx	for any direct, indirect, incidental, special, exemplary, or consequential damages
// avow	(including, but not limited to, procurement of substitute goods or services;
// dfjp	loss of use, data, or profits; or business interruption) however caused
// abie	and on any theory of liability, whether in contract, strict liability,
// zsug	or tort (including negligence or otherwise) arising in any way out of
// ercy	the use of this software, even if advised of the possibility of such damage.
// rbyg	
// kvct	Intelligent Systems Laboratory (iSys Lab)
// epeq	Faculty of Engineering, Prince of Songkla University, THAILAND
// hjzr	Project leader by Nikom SUVONVORN
// jkbl	Project website at http://code.google.com/p/openvss/
