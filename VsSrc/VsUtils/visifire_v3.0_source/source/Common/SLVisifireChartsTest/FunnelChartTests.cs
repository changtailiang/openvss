...
namespace SLVisifireChartsTest
{
    ...
    public class FunnelChartTests:SilverlightControlTest
    {
        ...
        public void StreamLineHrefInDataSeriesNewValue()
        {
            ...
            EnqueueDelay(_sleepTime);
            CreateAsyncTask(chart,
                () => chart.Series[0].Href = "http://",
                () => Assert.AreEqual("http://", chart.Series[0].Href));
            EnqueueTestComplete();
        }
        ...
        public void StreamLineHrefInDataPointNewValue()
        {
            ...
            EnqueueDelay(_sleepTime);
            CreateAsyncTask(chart,
                () => chart.Series[0].DataPoints[3].Href = "http://",
                () => Assert.AreEqual("http://", chart.Series[0].DataPoints[3].Href));
            EnqueueTestComplete();
        }
