...
#define cmdidDropTrigger 0x0142

#define cmdidCreateUDF 0x0150
#define cmdidAlterUDF 0x0151
#define cmdidDropUDF 0x0152

#define cmdidEditTableData 0x0160

#define cmdidNewQuery 0x0200

#define grpidAddNew 0x7000