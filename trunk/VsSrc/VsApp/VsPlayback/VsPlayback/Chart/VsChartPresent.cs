// isfc	 IMPORTANT: READ BEFORE DOWNLOADING, COPYING, INSTALLING OR USING. 
// janc	
// ohty	 By downloading, copying, installing or using the software you agree to this license.
// ezfq	 If you do not agree to this license, do not download, install,
// qbyd	 copy or use the software.
// tkkp	
// dhta	                          License Agreement
// ltpy	         For OpenVSS - Open Source Video Surveillance System
// xxhi	
// vvfp	Copyright (C) 2007-2010, Prince of Songkla University, All rights reserved.
// qvfw	
// wfxj	Third party copyrights are property of their respective owners.
// fajh	
// vorx	Redistribution and use in source and binary forms, with or without modification,
// iqzc	are permitted provided that the following conditions are met:
// hmru	
// rubh	  * Redistribution's of source code must retain the above copyright notice,
// swuu	    this list of conditions and the following disclaimer.
// winx	
// fntx	  * Redistribution's in binary form must reproduce the above copyright notice,
// jkvk	    this list of conditions and the following disclaimer in the documentation
// kidi	    and/or other materials provided with the distribution.
// gjaf	
// wche	  * Neither the name of the copyright holders nor the names of its contributors 
// ekfb	    may not be used to endorse or promote products derived from this software 
// eqqj	    without specific prior written permission.
// fokm	
// btsv	This software is provided by the copyright holders and contributors "as is" and
// wbtw	any express or implied warranties, including, but not limited to, the implied
// rgki	warranties of merchantability and fitness for a particular purpose are disclaimed.
// rtbj	In no event shall the Prince of Songkla University or contributors be liable 
// woyu	for any direct, indirect, incidental, special, exemplary, or consequential damages
// bjtu	(including, but not limited to, procurement of substitute goods or services;
// hrts	loss of use, data, or profits; or business interruption) however caused
// tmfv	and on any theory of liability, whether in contract, strict liability,
// xrhm	or tort (including negligence or otherwise) arising in any way out of
// qejv	the use of this software, even if advised of the possibility of such damage.
// ilnx	
// awkl	Intelligent Systems Laboratory (iSys Lab)
// phmq	Faculty of Engineering, Prince of Songkla University, THAILAND
// pqlr	Project leader by Nikom SUVONVORN
// axne	Project website at http://code.google.com/p/openvss/
