// snpz	 IMPORTANT: READ BEFORE DOWNLOADING, COPYING, INSTALLING OR USING. 
// cbzr	
// rmea	 By downloading, copying, installing or using the software you agree to this license.
// wohu	 If you do not agree to this license, do not download, install,
// bdrm	 copy or use the software.
// khpu	
// flmc	                          License Agreement
// sbbs	         For OpenVSS - Open Source Video Surveillance System
// rijs	
// rdvf	Copyright (C) 2007-2010, Prince of Songkla University, All rights reserved.
// zxsu	
// puht	Third party copyrights are property of their respective owners.
// kyfz	
// jqtk	Redistribution and use in source and binary forms, with or without modification,
// xvtr	are permitted provided that the following conditions are met:
// pwyp	
// lmjo	  * Redistribution's of source code must retain the above copyright notice,
// eodx	    this list of conditions and the following disclaimer.
// hmmm	
// oufk	  * Redistribution's in binary form must reproduce the above copyright notice,
// esru	    this list of conditions and the following disclaimer in the documentation
// vbja	    and/or other materials provided with the distribution.
// pyuw	
// jeqd	  * Neither the name of the copyright holders nor the names of its contributors 
// zdjc	    may not be used to endorse or promote products derived from this software 
// ltov	    without specific prior written permission.
// vhrw	
// egwc	This software is provided by the copyright holders and contributors "as is" and
// pjnw	any express or implied warranties, including, but not limited to, the implied
// fetj	warranties of merchantability and fitness for a particular purpose are disclaimed.
// diyg	In no event shall the Prince of Songkla University or contributors be liable 
// uhod	for any direct, indirect, incidental, special, exemplary, or consequential damages
// wjnl	(including, but not limited to, procurement of substitute goods or services;
// lcyk	loss of use, data, or profits; or business interruption) however caused
// evyo	and on any theory of liability, whether in contract, strict liability,
// jmwi	or tort (including negligence or otherwise) arising in any way out of
// crgz	the use of this software, even if advised of the possibility of such damage.
// rtxu	
// jzzc	Intelligent Systems Laboratory (iSys Lab)
// uibo	Faculty of Engineering, Prince of Songkla University, THAILAND
// soau	Project leader by Nikom SUVONVORN
// skrm	Project website at http://code.google.com/p/openvss/

namespace Vs.Monitor.VsService {
    ...
    public partial class VsService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback getCamConfigToStringOperationCompleted;
        
        private System.Threading.SendOrPostCallback getCamConfigToByteOperationCompleted;
        ...
        /// <remarks/>
        public VsService() {
            this.Url = global::Vs.Monitor.Properties.Settings.Default.VsLive_VsService_VsService;
        ...
        /// <remarks/>
        public event getCamConfigToStringCompletedEventHandler getCamConfigToStringCompleted;
        
        /// <remarks/>
        public event getCamConfigToByteCompletedEventHandler getCamConfigToByteCompleted;
        ...
        /// <remarks/>
        public void getCamConfigToStringAsync() {
            this.getCamConfigToStringAsync(null);
        }
        
        /// <remarks/>
        public void getCamConfigToStringAsync(object userState) {
            if ((this.getCamConfigToStringOperationCompleted == null)) {
                this.getCamConfigToStringOperationCompleted = new System.Threading.SendOrPostCallback(this.OngetCamConfigToStringOperationCompleted);
            }
            this.InvokeAsync("getCamConfigToString", new object[0], this.getCamConfigToStringOperationCompleted, userState);
        }
        
        private void OngetCamConfigToStringOperationCompleted(object arg) {
            if ((this.getCamConfigToStringCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.getCamConfigToStringCompleted(this, new getCamConfigToStringCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        public void getCamConfigToByteAsync() {
            this.getCamConfigToByteAsync(null);
        }
        
        /// <remarks/>
        public void getCamConfigToByteAsync(object userState) {
            if ((this.getCamConfigToByteOperationCompleted == null)) {
                this.getCamConfigToByteOperationCompleted = new System.Threading.SendOrPostCallback(this.OngetCamConfigToByteOperationCompleted);
            }
            this.InvokeAsync("getCamConfigToByte", new object[0], this.getCamConfigToByteOperationCompleted, userState);
        }
        
        private void OngetCamConfigToByteOperationCompleted(object arg) {
            if ((this.getCamConfigToByteCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.getCamConfigToByteCompleted(this, new getCamConfigToByteCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.1433")]
    public delegate void getCamConfigToStringCompletedEventHandler(object sender, getCamConfigToStringCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.1433")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class getCamConfigToStringCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal getCamConfigToStringCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.1433")]
    public delegate void getCamConfigToByteCompletedEventHandler(object sender, getCamConfigToByteCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.1433")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class getCamConfigToByteCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal getCamConfigToByteCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
