...
namespace MSR.LST.Net.Rtp
{
    ...
    internal class RtpFrame
    {
        ...
        private uint length;
        private bool packetsInFrameIsSet = false;
        ...
        public uint PacketsInFrame
        {
            set 
            {
                packetsInFrame = value;            
                packetsInFrameIsSet = true;
            }
        }
        ...
        public bool Complete
        {
            get
            {
                if(packetsInFrameIsSet)
                {
                    if (packetsInFrame == packetsReceived)
                        return true;
                    else return false;
                }
                else return false;
        ...
        public void ApproximatePacketsInFrame(uint packets)
        {
            // Grow pool if necessary
            if (packets > poolLength)
            {
